 ...
 * `src/v15/customer_customizer_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './customer_customizer_service_client_config.json';
 ...
 * @memberof v15
 */
export class CustomerCustomizerServiceClient {
  ...
  customerCustomizerServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof CustomerCustomizerServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v15.services.CustomerCustomizerService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.customerCustomizerServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v15.services.CustomerCustomizerService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v15.services.CustomerCustomizerService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const customerCustomizerServiceStubMethods =
        ['mutateCustomerCustomizers'];
    for (const methodName of customerCustomizerServiceStubMethods) {
      const callPromise = this.customerCustomizerServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v15.services.MutateCustomerCustomizersResponse|MutateCustomerCustomizersResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v15/customer_customizer_service.mutate_customer_customizers.js</caption>
 * region_tag:googleads_v15_generated_CustomerCustomizerService_MutateCustomerCustomizers_async
 */
  mutateCustomerCustomizers(
      request?: protos.google.ads.googleads.v15.services.IMutateCustomerCustomizersRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v15.services.IMutateCustomerCustomizersResponse,
        protos.google.ads.googleads.v15.services.IMutateCustomerCustomizersRequest|undefined, {}|undefined
      ]>;
  mutateCustomerCustomizers(
      request: protos.google.ads.googleads.v15.services.IMutateCustomerCustomizersRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v15.services.IMutateCustomerCustomizersResponse,
          protos.google.ads.googleads.v15.services.IMutateCustomerCustomizersRequest|null|undefined,
          {}|null|undefined>): void;
  mutateCustomerCustomizers(
      request: protos.google.ads.googleads.v15.services.IMutateCustomerCustomizersRequest,
      callback: Callback<
