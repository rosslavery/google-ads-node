 ...
 * `src/v15/ad_group_criterion_customizer_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './ad_group_criterion_customizer_service_client_config.json';
 ...
 * @memberof v15
 */
export class AdGroupCriterionCustomizerServiceClient {
  ...
  adGroupCriterionCustomizerServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof AdGroupCriterionCustomizerServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v15.services.AdGroupCriterionCustomizerService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.adGroupCriterionCustomizerServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v15.services.AdGroupCriterionCustomizerService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v15.services.AdGroupCriterionCustomizerService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const adGroupCriterionCustomizerServiceStubMethods =
        ['mutateAdGroupCriterionCustomizers'];
    for (const methodName of adGroupCriterionCustomizerServiceStubMethods) {
      const callPromise = this.adGroupCriterionCustomizerServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v15.services.MutateAdGroupCriterionCustomizersResponse|MutateAdGroupCriterionCustomizersResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v15/ad_group_criterion_customizer_service.mutate_ad_group_criterion_customizers.js</caption>
 * region_tag:googleads_v15_generated_AdGroupCriterionCustomizerService_MutateAdGroupCriterionCustomizers_async
 */
  mutateAdGroupCriterionCustomizers(
      request?: protos.google.ads.googleads.v15.services.IMutateAdGroupCriterionCustomizersRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v15.services.IMutateAdGroupCriterionCustomizersResponse,
        protos.google.ads.googleads.v15.services.IMutateAdGroupCriterionCustomizersRequest|undefined, {}|undefined
      ]>;
  mutateAdGroupCriterionCustomizers(
      request: protos.google.ads.googleads.v15.services.IMutateAdGroupCriterionCustomizersRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v15.services.IMutateAdGroupCriterionCustomizersResponse,
          protos.google.ads.googleads.v15.services.IMutateAdGroupCriterionCustomizersRequest|null|undefined,
          {}|null|undefined>): void;
  mutateAdGroupCriterionCustomizers(
      request: protos.google.ads.googleads.v15.services.IMutateAdGroupCriterionCustomizersRequest,
      callback: Callback<
