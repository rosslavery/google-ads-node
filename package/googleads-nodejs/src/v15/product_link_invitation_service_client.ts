 ...
 * `src/v15/product_link_invitation_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './product_link_invitation_service_client_config.json';
 ...
 * @memberof v15
 */
export class ProductLinkInvitationServiceClient {
  ...
  productLinkInvitationServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof ProductLinkInvitationServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v15.services.ProductLinkInvitationService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.productLinkInvitationServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v15.services.ProductLinkInvitationService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v15.services.ProductLinkInvitationService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const productLinkInvitationServiceStubMethods =
        ['updateProductLinkInvitation'];
    for (const methodName of productLinkInvitationServiceStubMethods) {
      const callPromise = this.productLinkInvitationServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 * @param {google.ads.googleads.v15.enums.ProductLinkInvitationStatusEnum.ProductLinkInvitationStatus} request.productLinkInvitationStatus
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v15.services.UpdateProductLinkInvitationResponse|UpdateProductLinkInvitationResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v15/product_link_invitation_service.update_product_link_invitation.js</caption>
 * region_tag:googleads_v15_generated_ProductLinkInvitationService_UpdateProductLinkInvitation_async
 */
  updateProductLinkInvitation(
      request?: protos.google.ads.googleads.v15.services.IUpdateProductLinkInvitationRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v15.services.IUpdateProductLinkInvitationResponse,
        protos.google.ads.googleads.v15.services.IUpdateProductLinkInvitationRequest|undefined, {}|undefined
      ]>;
  updateProductLinkInvitation(
      request: protos.google.ads.googleads.v15.services.IUpdateProductLinkInvitationRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v15.services.IUpdateProductLinkInvitationResponse,
          protos.google.ads.googleads.v15.services.IUpdateProductLinkInvitationRequest|null|undefined,
          {}|null|undefined>): void;
  updateProductLinkInvitation(
      request: protos.google.ads.googleads.v15.services.IUpdateProductLinkInvitationRequest,
      callback: Callback<
  ...
  updateProductLinkInvitation(
    ...
    this.initialize();
    return this.innerApiCalls.updateProductLinkInvitation(request, options, callback);
  }
