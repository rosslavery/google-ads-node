 ...
 * `src/v15/ad_group_label_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './ad_group_label_service_client_config.json';
...
export class AdGroupLabelServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v15.services.AdGroupLabelService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.adGroupLabelServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v15.services.AdGroupLabelService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v15.services.AdGroupLabelService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const adGroupLabelServiceStubMethods =
        ['mutateAdGroupLabels'];
    for (const methodName of adGroupLabelServiceStubMethods) {
      const callPromise = this.adGroupLabelServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v15.services.MutateAdGroupLabelsResponse|MutateAdGroupLabelsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v15/ad_group_label_service.mutate_ad_group_labels.js</caption>
 * region_tag:googleads_v15_generated_AdGroupLabelService_MutateAdGroupLabels_async
 */
  mutateAdGroupLabels(
      request?: protos.google.ads.googleads.v15.services.IMutateAdGroupLabelsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v15.services.IMutateAdGroupLabelsResponse,
        protos.google.ads.googleads.v15.services.IMutateAdGroupLabelsRequest|undefined, {}|undefined
      ]>;
  mutateAdGroupLabels(
      request: protos.google.ads.googleads.v15.services.IMutateAdGroupLabelsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v15.services.IMutateAdGroupLabelsResponse,
          protos.google.ads.googleads.v15.services.IMutateAdGroupLabelsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateAdGroupLabels(
      request: protos.google.ads.googleads.v15.services.IMutateAdGroupLabelsRequest,
      callback: Callback<
