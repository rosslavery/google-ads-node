 ...
 * `src/v15/customizer_attribute_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './customizer_attribute_service_client_config.json';
 ...
 * @memberof v15
 */
export class CustomizerAttributeServiceClient {
  ...
  customizerAttributeServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof CustomizerAttributeServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v15.services.CustomizerAttributeService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.customizerAttributeServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v15.services.CustomizerAttributeService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v15.services.CustomizerAttributeService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const customizerAttributeServiceStubMethods =
        ['mutateCustomizerAttributes'];
    for (const methodName of customizerAttributeServiceStubMethods) {
      const callPromise = this.customizerAttributeServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v15.services.MutateCustomizerAttributesResponse|MutateCustomizerAttributesResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v15/customizer_attribute_service.mutate_customizer_attributes.js</caption>
 * region_tag:googleads_v15_generated_CustomizerAttributeService_MutateCustomizerAttributes_async
 */
  mutateCustomizerAttributes(
      request?: protos.google.ads.googleads.v15.services.IMutateCustomizerAttributesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v15.services.IMutateCustomizerAttributesResponse,
        protos.google.ads.googleads.v15.services.IMutateCustomizerAttributesRequest|undefined, {}|undefined
      ]>;
  mutateCustomizerAttributes(
      request: protos.google.ads.googleads.v15.services.IMutateCustomizerAttributesRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v15.services.IMutateCustomizerAttributesResponse,
          protos.google.ads.googleads.v15.services.IMutateCustomizerAttributesRequest|null|undefined,
          {}|null|undefined>): void;
  mutateCustomizerAttributes(
      request: protos.google.ads.googleads.v15.services.IMutateCustomizerAttributesRequest,
      callback: Callback<
