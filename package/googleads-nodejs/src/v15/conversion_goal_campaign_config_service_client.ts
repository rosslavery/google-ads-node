 ...
 */
import * as gapicConfig from './conversion_goal_campaign_config_service_client_config.json';
 ...
 * @memberof v15
 */
export class ConversionGoalCampaignConfigServiceClient {
  ...
  conversionGoalCampaignConfigServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof ConversionGoalCampaignConfigServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v15.services.ConversionGoalCampaignConfigService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.conversionGoalCampaignConfigServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v15.services.ConversionGoalCampaignConfigService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v15.services.ConversionGoalCampaignConfigService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const conversionGoalCampaignConfigServiceStubMethods =
        ['mutateConversionGoalCampaignConfigs'];
    for (const methodName of conversionGoalCampaignConfigServiceStubMethods) {
      const callPromise = this.conversionGoalCampaignConfigServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v15.services.MutateConversionGoalCampaignConfigsResponse|MutateConversionGoalCampaignConfigsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v15/conversion_goal_campaign_config_service.mutate_conversion_goal_campaign_configs.js</caption>
 * region_tag:googleads_v15_generated_ConversionGoalCampaignConfigService_MutateConversionGoalCampaignConfigs_async
 */
  mutateConversionGoalCampaignConfigs(
      request?: protos.google.ads.googleads.v15.services.IMutateConversionGoalCampaignConfigsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v15.services.IMutateConversionGoalCampaignConfigsResponse,
        protos.google.ads.googleads.v15.services.IMutateConversionGoalCampaignConfigsRequest|undefined, {}|undefined
      ]>;
  mutateConversionGoalCampaignConfigs(
      request: protos.google.ads.googleads.v15.services.IMutateConversionGoalCampaignConfigsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v15.services.IMutateConversionGoalCampaignConfigsResponse,
          protos.google.ads.googleads.v15.services.IMutateConversionGoalCampaignConfigsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateConversionGoalCampaignConfigs(
      request: protos.google.ads.googleads.v15.services.IMutateConversionGoalCampaignConfigsRequest,
      callback: Callback<
