 ...
 * `src/v15/asset_group_asset_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './asset_group_asset_service_client_config.json';
 ...
 * @memberof v15
 */
export class AssetGroupAssetServiceClient {
  ...
  assetGroupAssetServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof AssetGroupAssetServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v15.services.AssetGroupAssetService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.assetGroupAssetServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v15.services.AssetGroupAssetService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v15.services.AssetGroupAssetService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const assetGroupAssetServiceStubMethods =
        ['mutateAssetGroupAssets'];
    for (const methodName of assetGroupAssetServiceStubMethods) {
      const callPromise = this.assetGroupAssetServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v15.services.MutateAssetGroupAssetsResponse|MutateAssetGroupAssetsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v15/asset_group_asset_service.mutate_asset_group_assets.js</caption>
 * region_tag:googleads_v15_generated_AssetGroupAssetService_MutateAssetGroupAssets_async
 */
  mutateAssetGroupAssets(
      request?: protos.google.ads.googleads.v15.services.IMutateAssetGroupAssetsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v15.services.IMutateAssetGroupAssetsResponse,
        protos.google.ads.googleads.v15.services.IMutateAssetGroupAssetsRequest|undefined, {}|undefined
      ]>;
  mutateAssetGroupAssets(
      request: protos.google.ads.googleads.v15.services.IMutateAssetGroupAssetsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v15.services.IMutateAssetGroupAssetsResponse,
          protos.google.ads.googleads.v15.services.IMutateAssetGroupAssetsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateAssetGroupAssets(
      request: protos.google.ads.googleads.v15.services.IMutateAssetGroupAssetsRequest,
      callback: Callback<
