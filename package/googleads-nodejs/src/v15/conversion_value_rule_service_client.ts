 ...
 * `src/v15/conversion_value_rule_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './conversion_value_rule_service_client_config.json';
 ...
 * @memberof v15
 */
export class ConversionValueRuleServiceClient {
  ...
  conversionValueRuleServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof ConversionValueRuleServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v15.services.ConversionValueRuleService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.conversionValueRuleServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v15.services.ConversionValueRuleService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v15.services.ConversionValueRuleService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const conversionValueRuleServiceStubMethods =
        ['mutateConversionValueRules'];
    for (const methodName of conversionValueRuleServiceStubMethods) {
      const callPromise = this.conversionValueRuleServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v15.services.MutateConversionValueRulesResponse|MutateConversionValueRulesResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v15/conversion_value_rule_service.mutate_conversion_value_rules.js</caption>
 * region_tag:googleads_v15_generated_ConversionValueRuleService_MutateConversionValueRules_async
 */
  mutateConversionValueRules(
      request?: protos.google.ads.googleads.v15.services.IMutateConversionValueRulesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v15.services.IMutateConversionValueRulesResponse,
        protos.google.ads.googleads.v15.services.IMutateConversionValueRulesRequest|undefined, {}|undefined
      ]>;
  mutateConversionValueRules(
      request: protos.google.ads.googleads.v15.services.IMutateConversionValueRulesRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v15.services.IMutateConversionValueRulesResponse,
          protos.google.ads.googleads.v15.services.IMutateConversionValueRulesRequest|null|undefined,
          {}|null|undefined>): void;
  mutateConversionValueRules(
      request: protos.google.ads.googleads.v15.services.IMutateConversionValueRulesRequest,
      callback: Callback<
