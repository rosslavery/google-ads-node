 ...
 * `src/v15/keyword_plan_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './keyword_plan_service_client_config.json';
...
export class KeywordPlanServiceClient {
  ...
  keywordPlanServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof KeywordPlanServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v15.services.KeywordPlanService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.keywordPlanServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v15.services.KeywordPlanService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v15.services.KeywordPlanService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const keywordPlanServiceStubMethods =
        ['mutateKeywordPlans'];
    for (const methodName of keywordPlanServiceStubMethods) {
      const callPromise = this.keywordPlanServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v15.services.MutateKeywordPlansResponse|MutateKeywordPlansResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v15/keyword_plan_service.mutate_keyword_plans.js</caption>
 * region_tag:googleads_v15_generated_KeywordPlanService_MutateKeywordPlans_async
 */
  mutateKeywordPlans(
      request?: protos.google.ads.googleads.v15.services.IMutateKeywordPlansRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v15.services.IMutateKeywordPlansResponse,
        protos.google.ads.googleads.v15.services.IMutateKeywordPlansRequest|undefined, {}|undefined
      ]>;
  mutateKeywordPlans(
      request: protos.google.ads.googleads.v15.services.IMutateKeywordPlansRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v15.services.IMutateKeywordPlansResponse,
          protos.google.ads.googleads.v15.services.IMutateKeywordPlansRequest|null|undefined,
          {}|null|undefined>): void;
  mutateKeywordPlans(
      request: protos.google.ads.googleads.v15.services.IMutateKeywordPlansRequest,
      callback: Callback<
