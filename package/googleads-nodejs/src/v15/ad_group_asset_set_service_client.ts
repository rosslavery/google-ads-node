 ...
 * `src/v15/ad_group_asset_set_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './ad_group_asset_set_service_client_config.json';
 ...
 * @memberof v15
 */
export class AdGroupAssetSetServiceClient {
  ...
  adGroupAssetSetServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof AdGroupAssetSetServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v15.services.AdGroupAssetSetService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.adGroupAssetSetServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v15.services.AdGroupAssetSetService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v15.services.AdGroupAssetSetService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const adGroupAssetSetServiceStubMethods =
        ['mutateAdGroupAssetSets'];
    for (const methodName of adGroupAssetSetServiceStubMethods) {
      const callPromise = this.adGroupAssetSetServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v15.services.MutateAdGroupAssetSetsResponse|MutateAdGroupAssetSetsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v15/ad_group_asset_set_service.mutate_ad_group_asset_sets.js</caption>
 * region_tag:googleads_v15_generated_AdGroupAssetSetService_MutateAdGroupAssetSets_async
 */
  mutateAdGroupAssetSets(
      request?: protos.google.ads.googleads.v15.services.IMutateAdGroupAssetSetsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v15.services.IMutateAdGroupAssetSetsResponse,
        protos.google.ads.googleads.v15.services.IMutateAdGroupAssetSetsRequest|undefined, {}|undefined
      ]>;
  mutateAdGroupAssetSets(
      request: protos.google.ads.googleads.v15.services.IMutateAdGroupAssetSetsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v15.services.IMutateAdGroupAssetSetsResponse,
          protos.google.ads.googleads.v15.services.IMutateAdGroupAssetSetsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateAdGroupAssetSets(
      request: protos.google.ads.googleads.v15.services.IMutateAdGroupAssetSetsRequest,
      callback: Callback<
  ...
  mutateAdGroupAssetSets(
    ...
    this.initialize();
    return this.innerApiCalls.mutateAdGroupAssetSets(request, options, callback);
  }
