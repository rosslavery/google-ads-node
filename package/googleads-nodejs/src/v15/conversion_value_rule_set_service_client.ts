 ...
 * `src/v15/conversion_value_rule_set_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './conversion_value_rule_set_service_client_config.json';
 ...
 * @memberof v15
 */
export class ConversionValueRuleSetServiceClient {
  ...
  conversionValueRuleSetServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof ConversionValueRuleSetServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v15.services.ConversionValueRuleSetService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.conversionValueRuleSetServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v15.services.ConversionValueRuleSetService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v15.services.ConversionValueRuleSetService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const conversionValueRuleSetServiceStubMethods =
        ['mutateConversionValueRuleSets'];
    for (const methodName of conversionValueRuleSetServiceStubMethods) {
      const callPromise = this.conversionValueRuleSetServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v15.services.MutateConversionValueRuleSetsResponse|MutateConversionValueRuleSetsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v15/conversion_value_rule_set_service.mutate_conversion_value_rule_sets.js</caption>
 * region_tag:googleads_v15_generated_ConversionValueRuleSetService_MutateConversionValueRuleSets_async
 */
  mutateConversionValueRuleSets(
      request?: protos.google.ads.googleads.v15.services.IMutateConversionValueRuleSetsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v15.services.IMutateConversionValueRuleSetsResponse,
        protos.google.ads.googleads.v15.services.IMutateConversionValueRuleSetsRequest|undefined, {}|undefined
      ]>;
  mutateConversionValueRuleSets(
      request: protos.google.ads.googleads.v15.services.IMutateConversionValueRuleSetsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v15.services.IMutateConversionValueRuleSetsResponse,
          protos.google.ads.googleads.v15.services.IMutateConversionValueRuleSetsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateConversionValueRuleSets(
      request: protos.google.ads.googleads.v15.services.IMutateConversionValueRuleSetsRequest,
      callback: Callback<
