 ...
 * `src/v15/recommendation_subscription_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './recommendation_subscription_service_client_config.json';
 ...
 * @memberof v15
 */
export class RecommendationSubscriptionServiceClient {
  ...
  recommendationSubscriptionServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof RecommendationSubscriptionServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v15.services.RecommendationSubscriptionService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.recommendationSubscriptionServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v15.services.RecommendationSubscriptionService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v15.services.RecommendationSubscriptionService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const recommendationSubscriptionServiceStubMethods =
        ['mutateRecommendationSubscription'];
    for (const methodName of recommendationSubscriptionServiceStubMethods) {
      const callPromise = this.recommendationSubscriptionServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v15.services.MutateRecommendationSubscriptionResponse|MutateRecommendationSubscriptionResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v15/recommendation_subscription_service.mutate_recommendation_subscription.js</caption>
 * region_tag:googleads_v15_generated_RecommendationSubscriptionService_MutateRecommendationSubscription_async
 */
  mutateRecommendationSubscription(
      request?: protos.google.ads.googleads.v15.services.IMutateRecommendationSubscriptionRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v15.services.IMutateRecommendationSubscriptionResponse,
        protos.google.ads.googleads.v15.services.IMutateRecommendationSubscriptionRequest|undefined, {}|undefined
      ]>;
  mutateRecommendationSubscription(
      request: protos.google.ads.googleads.v15.services.IMutateRecommendationSubscriptionRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v15.services.IMutateRecommendationSubscriptionResponse,
          protos.google.ads.googleads.v15.services.IMutateRecommendationSubscriptionRequest|null|undefined,
          {}|null|undefined>): void;
  mutateRecommendationSubscription(
      request: protos.google.ads.googleads.v15.services.IMutateRecommendationSubscriptionRequest,
      callback: Callback<
  ...
  mutateRecommendationSubscription(
    ...
    this.initialize();
    return this.innerApiCalls.mutateRecommendationSubscription(request, options, callback);
  }
