 ...
 * `src/v15/bidding_data_exclusion_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './bidding_data_exclusion_service_client_config.json';
 ...
 * @memberof v15
 */
export class BiddingDataExclusionServiceClient {
  ...
  biddingDataExclusionServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof BiddingDataExclusionServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v15.services.BiddingDataExclusionService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.biddingDataExclusionServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v15.services.BiddingDataExclusionService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v15.services.BiddingDataExclusionService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const biddingDataExclusionServiceStubMethods =
        ['mutateBiddingDataExclusions'];
    for (const methodName of biddingDataExclusionServiceStubMethods) {
      const callPromise = this.biddingDataExclusionServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v15.services.MutateBiddingDataExclusionsResponse|MutateBiddingDataExclusionsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v15/bidding_data_exclusion_service.mutate_bidding_data_exclusions.js</caption>
 * region_tag:googleads_v15_generated_BiddingDataExclusionService_MutateBiddingDataExclusions_async
 */
  mutateBiddingDataExclusions(
      request?: protos.google.ads.googleads.v15.services.IMutateBiddingDataExclusionsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v15.services.IMutateBiddingDataExclusionsResponse,
        protos.google.ads.googleads.v15.services.IMutateBiddingDataExclusionsRequest|undefined, {}|undefined
      ]>;
  mutateBiddingDataExclusions(
      request: protos.google.ads.googleads.v15.services.IMutateBiddingDataExclusionsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v15.services.IMutateBiddingDataExclusionsResponse,
          protos.google.ads.googleads.v15.services.IMutateBiddingDataExclusionsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateBiddingDataExclusions(
      request: protos.google.ads.googleads.v15.services.IMutateBiddingDataExclusionsRequest,
      callback: Callback<
