 ...
 * `src/v15/campaign_lifecycle_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './campaign_lifecycle_service_client_config.json';
 ...
 * @memberof v15
 */
export class CampaignLifecycleServiceClient {
  ...
  campaignLifecycleServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of CampaignLifecycleServiceClient.
   *
   ...
   *     const client = new CampaignLifecycleServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof CampaignLifecycleServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v15.services.CampaignLifecycleService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.campaignLifecycleServiceStub) {
      return this.campaignLifecycleServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.googleads.v15.services.CampaignLifecycleService.
    this.campaignLifecycleServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v15.services.CampaignLifecycleService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v15.services.CampaignLifecycleService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const campaignLifecycleServiceStubMethods =
        ['configureCampaignLifecycleGoals'];
    for (const methodName of campaignLifecycleServiceStubMethods) {
      const callPromise = this.campaignLifecycleServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 * @param {google.ads.googleads.v15.services.CampaignLifecycleGoalOperation} request.operation
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v15.services.ConfigureCampaignLifecycleGoalsResponse|ConfigureCampaignLifecycleGoalsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v15/campaign_lifecycle_service.configure_campaign_lifecycle_goals.js</caption>
 * region_tag:googleads_v15_generated_CampaignLifecycleService_ConfigureCampaignLifecycleGoals_async
 */
  configureCampaignLifecycleGoals(
      request?: protos.google.ads.googleads.v15.services.IConfigureCampaignLifecycleGoalsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v15.services.IConfigureCampaignLifecycleGoalsResponse,
        protos.google.ads.googleads.v15.services.IConfigureCampaignLifecycleGoalsRequest|undefined, {}|undefined
      ]>;
  configureCampaignLifecycleGoals(
      request: protos.google.ads.googleads.v15.services.IConfigureCampaignLifecycleGoalsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v15.services.IConfigureCampaignLifecycleGoalsResponse,
          protos.google.ads.googleads.v15.services.IConfigureCampaignLifecycleGoalsRequest|null|undefined,
          {}|null|undefined>): void;
  configureCampaignLifecycleGoals(
      request: protos.google.ads.googleads.v15.services.IConfigureCampaignLifecycleGoalsRequest,
      callback: Callback<
  ...
  configureCampaignLifecycleGoals(
    ...
    this.initialize();
    return this.innerApiCalls.configureCampaignLifecycleGoals(request, options, callback);
  }
   ...
   */
  close(): Promise<void> {
    if (this.campaignLifecycleServiceStub && !this._terminated) {
      return this.campaignLifecycleServiceStub.then(stub => {
