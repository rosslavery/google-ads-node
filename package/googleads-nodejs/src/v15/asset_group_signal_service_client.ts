 ...
 * `src/v15/asset_group_signal_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './asset_group_signal_service_client_config.json';
 ...
 * @memberof v15
 */
export class AssetGroupSignalServiceClient {
  ...
  assetGroupSignalServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof AssetGroupSignalServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v15.services.AssetGroupSignalService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.assetGroupSignalServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v15.services.AssetGroupSignalService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v15.services.AssetGroupSignalService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const assetGroupSignalServiceStubMethods =
        ['mutateAssetGroupSignals'];
    for (const methodName of assetGroupSignalServiceStubMethods) {
      const callPromise = this.assetGroupSignalServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v15.services.MutateAssetGroupSignalsResponse|MutateAssetGroupSignalsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v15/asset_group_signal_service.mutate_asset_group_signals.js</caption>
 * region_tag:googleads_v15_generated_AssetGroupSignalService_MutateAssetGroupSignals_async
 */
  mutateAssetGroupSignals(
      request?: protos.google.ads.googleads.v15.services.IMutateAssetGroupSignalsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v15.services.IMutateAssetGroupSignalsResponse,
        protos.google.ads.googleads.v15.services.IMutateAssetGroupSignalsRequest|undefined, {}|undefined
      ]>;
  mutateAssetGroupSignals(
      request: protos.google.ads.googleads.v15.services.IMutateAssetGroupSignalsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v15.services.IMutateAssetGroupSignalsResponse,
          protos.google.ads.googleads.v15.services.IMutateAssetGroupSignalsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateAssetGroupSignals(
      request: protos.google.ads.googleads.v15.services.IMutateAssetGroupSignalsRequest,
      callback: Callback<
