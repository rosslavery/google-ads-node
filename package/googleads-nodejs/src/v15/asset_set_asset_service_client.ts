 ...
 * `src/v15/asset_set_asset_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './asset_set_asset_service_client_config.json';
 ...
 * @memberof v15
 */
export class AssetSetAssetServiceClient {
  ...
  assetSetAssetServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof AssetSetAssetServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v15.services.AssetSetAssetService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.assetSetAssetServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v15.services.AssetSetAssetService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v15.services.AssetSetAssetService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const assetSetAssetServiceStubMethods =
        ['mutateAssetSetAssets'];
    for (const methodName of assetSetAssetServiceStubMethods) {
      const callPromise = this.assetSetAssetServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v15.services.MutateAssetSetAssetsResponse|MutateAssetSetAssetsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v15/asset_set_asset_service.mutate_asset_set_assets.js</caption>
 * region_tag:googleads_v15_generated_AssetSetAssetService_MutateAssetSetAssets_async
 */
  mutateAssetSetAssets(
      request?: protos.google.ads.googleads.v15.services.IMutateAssetSetAssetsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v15.services.IMutateAssetSetAssetsResponse,
        protos.google.ads.googleads.v15.services.IMutateAssetSetAssetsRequest|undefined, {}|undefined
      ]>;
  mutateAssetSetAssets(
      request: protos.google.ads.googleads.v15.services.IMutateAssetSetAssetsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v15.services.IMutateAssetSetAssetsResponse,
          protos.google.ads.googleads.v15.services.IMutateAssetSetAssetsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateAssetSetAssets(
      request: protos.google.ads.googleads.v15.services.IMutateAssetSetAssetsRequest,
      callback: Callback<
