 ...
 * `src/v15/asset_set_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './asset_set_service_client_config.json';
 ...
 * @memberof v15
 */
export class AssetSetServiceClient {
  ...
  assetSetServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof AssetSetServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v15.services.AssetSetService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.assetSetServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v15.services.AssetSetService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v15.services.AssetSetService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const assetSetServiceStubMethods =
        ['mutateAssetSets'];
    for (const methodName of assetSetServiceStubMethods) {
      const callPromise = this.assetSetServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v15.services.MutateAssetSetsResponse|MutateAssetSetsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v15/asset_set_service.mutate_asset_sets.js</caption>
 * region_tag:googleads_v15_generated_AssetSetService_MutateAssetSets_async
 */
  mutateAssetSets(
      request?: protos.google.ads.googleads.v15.services.IMutateAssetSetsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v15.services.IMutateAssetSetsResponse,
        protos.google.ads.googleads.v15.services.IMutateAssetSetsRequest|undefined, {}|undefined
      ]>;
  mutateAssetSets(
      request: protos.google.ads.googleads.v15.services.IMutateAssetSetsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v15.services.IMutateAssetSetsResponse,
          protos.google.ads.googleads.v15.services.IMutateAssetSetsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateAssetSets(
      request: protos.google.ads.googleads.v15.services.IMutateAssetSetsRequest,
      callback: Callback<
