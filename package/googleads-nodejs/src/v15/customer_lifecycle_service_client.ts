 ...
 * `src/v15/customer_lifecycle_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './customer_lifecycle_service_client_config.json';
 ...
 * @memberof v15
 */
export class CustomerLifecycleServiceClient {
  ...
  customerLifecycleServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of CustomerLifecycleServiceClient.
   *
   ...
   *     const client = new CustomerLifecycleServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof CustomerLifecycleServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v15.services.CustomerLifecycleService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.customerLifecycleServiceStub) {
      return this.customerLifecycleServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.googleads.v15.services.CustomerLifecycleService.
    this.customerLifecycleServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v15.services.CustomerLifecycleService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v15.services.CustomerLifecycleService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const customerLifecycleServiceStubMethods =
        ['configureCustomerLifecycleGoals'];
    for (const methodName of customerLifecycleServiceStubMethods) {
      const callPromise = this.customerLifecycleServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 * @param {google.ads.googleads.v15.services.CustomerLifecycleGoalOperation} request.operation
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v15.services.ConfigureCustomerLifecycleGoalsResponse|ConfigureCustomerLifecycleGoalsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v15/customer_lifecycle_service.configure_customer_lifecycle_goals.js</caption>
 * region_tag:googleads_v15_generated_CustomerLifecycleService_ConfigureCustomerLifecycleGoals_async
 */
  configureCustomerLifecycleGoals(
      request?: protos.google.ads.googleads.v15.services.IConfigureCustomerLifecycleGoalsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v15.services.IConfigureCustomerLifecycleGoalsResponse,
        protos.google.ads.googleads.v15.services.IConfigureCustomerLifecycleGoalsRequest|undefined, {}|undefined
      ]>;
  configureCustomerLifecycleGoals(
      request: protos.google.ads.googleads.v15.services.IConfigureCustomerLifecycleGoalsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v15.services.IConfigureCustomerLifecycleGoalsResponse,
          protos.google.ads.googleads.v15.services.IConfigureCustomerLifecycleGoalsRequest|null|undefined,
          {}|null|undefined>): void;
  configureCustomerLifecycleGoals(
      request: protos.google.ads.googleads.v15.services.IConfigureCustomerLifecycleGoalsRequest,
      callback: Callback<
  ...
  configureCustomerLifecycleGoals(
    ...
    this.initialize();
    return this.innerApiCalls.configureCustomerLifecycleGoals(request, options, callback);
  }
   ...
   */
  close(): Promise<void> {
    if (this.customerLifecycleServiceStub && !this._terminated) {
      return this.customerLifecycleServiceStub.then(stub => {
