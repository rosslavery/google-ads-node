 ...
 * `src/v15/keyword_theme_constant_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './keyword_theme_constant_service_client_config.json';
 ...
 * @memberof v15
 */
export class KeywordThemeConstantServiceClient {
  ...
  keywordThemeConstantServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof KeywordThemeConstantServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v15.services.KeywordThemeConstantService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.keywordThemeConstantServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v15.services.KeywordThemeConstantService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v15.services.KeywordThemeConstantService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const keywordThemeConstantServiceStubMethods =
        ['suggestKeywordThemeConstants'];
    for (const methodName of keywordThemeConstantServiceStubMethods) {
      const callPromise = this.keywordThemeConstantServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v15.services.SuggestKeywordThemeConstantsResponse|SuggestKeywordThemeConstantsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v15/keyword_theme_constant_service.suggest_keyword_theme_constants.js</caption>
 * region_tag:googleads_v15_generated_KeywordThemeConstantService_SuggestKeywordThemeConstants_async
 */
  suggestKeywordThemeConstants(
      request?: protos.google.ads.googleads.v15.services.ISuggestKeywordThemeConstantsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v15.services.ISuggestKeywordThemeConstantsResponse,
        protos.google.ads.googleads.v15.services.ISuggestKeywordThemeConstantsRequest|undefined, {}|undefined
      ]>;
  suggestKeywordThemeConstants(
      request: protos.google.ads.googleads.v15.services.ISuggestKeywordThemeConstantsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v15.services.ISuggestKeywordThemeConstantsResponse,
          protos.google.ads.googleads.v15.services.ISuggestKeywordThemeConstantsRequest|null|undefined,
          {}|null|undefined>): void;
  suggestKeywordThemeConstants(
      request: protos.google.ads.googleads.v15.services.ISuggestKeywordThemeConstantsRequest,
      callback: Callback<
