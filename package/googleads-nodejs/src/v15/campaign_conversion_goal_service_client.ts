 ...
 * `src/v15/campaign_conversion_goal_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './campaign_conversion_goal_service_client_config.json';
 ...
 * @memberof v15
 */
export class CampaignConversionGoalServiceClient {
  ...
  campaignConversionGoalServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof CampaignConversionGoalServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v15.services.CampaignConversionGoalService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.campaignConversionGoalServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v15.services.CampaignConversionGoalService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v15.services.CampaignConversionGoalService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const campaignConversionGoalServiceStubMethods =
        ['mutateCampaignConversionGoals'];
    for (const methodName of campaignConversionGoalServiceStubMethods) {
      const callPromise = this.campaignConversionGoalServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v15.services.MutateCampaignConversionGoalsResponse|MutateCampaignConversionGoalsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v15/campaign_conversion_goal_service.mutate_campaign_conversion_goals.js</caption>
 * region_tag:googleads_v15_generated_CampaignConversionGoalService_MutateCampaignConversionGoals_async
 */
  mutateCampaignConversionGoals(
      request?: protos.google.ads.googleads.v15.services.IMutateCampaignConversionGoalsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v15.services.IMutateCampaignConversionGoalsResponse,
        protos.google.ads.googleads.v15.services.IMutateCampaignConversionGoalsRequest|undefined, {}|undefined
      ]>;
  mutateCampaignConversionGoals(
      request: protos.google.ads.googleads.v15.services.IMutateCampaignConversionGoalsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v15.services.IMutateCampaignConversionGoalsResponse,
          protos.google.ads.googleads.v15.services.IMutateCampaignConversionGoalsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateCampaignConversionGoals(
      request: protos.google.ads.googleads.v15.services.IMutateCampaignConversionGoalsRequest,
      callback: Callback<
