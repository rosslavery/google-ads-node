 ...
 * `src/v15/customer_client_link_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './customer_client_link_service_client_config.json';
...
export class CustomerClientLinkServiceClient {
  ...
  customerClientLinkServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof CustomerClientLinkServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v15.services.CustomerClientLinkService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.customerClientLinkServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v15.services.CustomerClientLinkService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v15.services.CustomerClientLinkService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const customerClientLinkServiceStubMethods =
        ['mutateCustomerClientLink'];
    for (const methodName of customerClientLinkServiceStubMethods) {
      const callPromise = this.customerClientLinkServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 * @param {google.ads.googleads.v15.services.CustomerClientLinkOperation} request.operation
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v15.services.MutateCustomerClientLinkResponse|MutateCustomerClientLinkResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v15/customer_client_link_service.mutate_customer_client_link.js</caption>
 * region_tag:googleads_v15_generated_CustomerClientLinkService_MutateCustomerClientLink_async
 */
  mutateCustomerClientLink(
      request?: protos.google.ads.googleads.v15.services.IMutateCustomerClientLinkRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v15.services.IMutateCustomerClientLinkResponse,
        protos.google.ads.googleads.v15.services.IMutateCustomerClientLinkRequest|undefined, {}|undefined
      ]>;
  mutateCustomerClientLink(
      request: protos.google.ads.googleads.v15.services.IMutateCustomerClientLinkRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v15.services.IMutateCustomerClientLinkResponse,
          protos.google.ads.googleads.v15.services.IMutateCustomerClientLinkRequest|null|undefined,
          {}|null|undefined>): void;
  mutateCustomerClientLink(
      request: protos.google.ads.googleads.v15.services.IMutateCustomerClientLinkRequest,
      callback: Callback<
