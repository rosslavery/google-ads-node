 ...
 * `src/v15/brand_suggestion_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './brand_suggestion_service_client_config.json';
 ...
 * @memberof v15
 */
export class BrandSuggestionServiceClient {
  ...
  brandSuggestionServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof BrandSuggestionServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v15.services.BrandSuggestionService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.brandSuggestionServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v15.services.BrandSuggestionService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v15.services.BrandSuggestionService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const brandSuggestionServiceStubMethods =
        ['suggestBrands'];
    for (const methodName of brandSuggestionServiceStubMethods) {
      const callPromise = this.brandSuggestionServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v15.services.SuggestBrandsResponse|SuggestBrandsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v15/brand_suggestion_service.suggest_brands.js</caption>
 * region_tag:googleads_v15_generated_BrandSuggestionService_SuggestBrands_async
 */
  suggestBrands(
      request?: protos.google.ads.googleads.v15.services.ISuggestBrandsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v15.services.ISuggestBrandsResponse,
        protos.google.ads.googleads.v15.services.ISuggestBrandsRequest|undefined, {}|undefined
      ]>;
  suggestBrands(
      request: protos.google.ads.googleads.v15.services.ISuggestBrandsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v15.services.ISuggestBrandsResponse,
          protos.google.ads.googleads.v15.services.ISuggestBrandsRequest|null|undefined,
          {}|null|undefined>): void;
  suggestBrands(
      request: protos.google.ads.googleads.v15.services.ISuggestBrandsRequest,
      callback: Callback<
  ...
  suggestBrands(
    ...
    this.initialize();
    return this.innerApiCalls.suggestBrands(request, options, callback);
  }
