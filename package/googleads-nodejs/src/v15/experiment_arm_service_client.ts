 ...
 * `src/v15/experiment_arm_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './experiment_arm_service_client_config.json';
 ...
 * @memberof v15
 */
export class ExperimentArmServiceClient {
  ...
  experimentArmServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof ExperimentArmServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v15.services.ExperimentArmService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.experimentArmServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v15.services.ExperimentArmService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v15.services.ExperimentArmService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const experimentArmServiceStubMethods =
        ['mutateExperimentArms'];
    for (const methodName of experimentArmServiceStubMethods) {
      const callPromise = this.experimentArmServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v15.services.MutateExperimentArmsResponse|MutateExperimentArmsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v15/experiment_arm_service.mutate_experiment_arms.js</caption>
 * region_tag:googleads_v15_generated_ExperimentArmService_MutateExperimentArms_async
 */
  mutateExperimentArms(
      request?: protos.google.ads.googleads.v15.services.IMutateExperimentArmsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v15.services.IMutateExperimentArmsResponse,
        protos.google.ads.googleads.v15.services.IMutateExperimentArmsRequest|undefined, {}|undefined
      ]>;
  mutateExperimentArms(
      request: protos.google.ads.googleads.v15.services.IMutateExperimentArmsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v15.services.IMutateExperimentArmsResponse,
          protos.google.ads.googleads.v15.services.IMutateExperimentArmsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateExperimentArms(
      request: protos.google.ads.googleads.v15.services.IMutateExperimentArmsRequest,
      callback: Callback<
