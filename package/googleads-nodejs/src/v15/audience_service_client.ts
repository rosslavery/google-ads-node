 ...
 * `src/v15/audience_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './audience_service_client_config.json';
 ...
 * @memberof v15
 */
export class AudienceServiceClient {
  ...
  audienceServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof AudienceServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v15.services.AudienceService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.audienceServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v15.services.AudienceService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v15.services.AudienceService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const audienceServiceStubMethods =
        ['mutateAudiences'];
    for (const methodName of audienceServiceStubMethods) {
      const callPromise = this.audienceServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v15.services.MutateAudiencesResponse|MutateAudiencesResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v15/audience_service.mutate_audiences.js</caption>
 * region_tag:googleads_v15_generated_AudienceService_MutateAudiences_async
 */
  mutateAudiences(
      request?: protos.google.ads.googleads.v15.services.IMutateAudiencesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v15.services.IMutateAudiencesResponse,
        protos.google.ads.googleads.v15.services.IMutateAudiencesRequest|undefined, {}|undefined
      ]>;
  mutateAudiences(
      request: protos.google.ads.googleads.v15.services.IMutateAudiencesRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v15.services.IMutateAudiencesResponse,
          protos.google.ads.googleads.v15.services.IMutateAudiencesRequest|null|undefined,
          {}|null|undefined>): void;
  mutateAudiences(
      request: protos.google.ads.googleads.v15.services.IMutateAudiencesRequest,
      callback: Callback<
