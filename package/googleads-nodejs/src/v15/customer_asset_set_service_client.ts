 ...
 * `src/v15/customer_asset_set_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './customer_asset_set_service_client_config.json';
 ...
 * @memberof v15
 */
export class CustomerAssetSetServiceClient {
  ...
  customerAssetSetServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof CustomerAssetSetServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v15.services.CustomerAssetSetService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.customerAssetSetServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v15.services.CustomerAssetSetService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v15.services.CustomerAssetSetService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const customerAssetSetServiceStubMethods =
        ['mutateCustomerAssetSets'];
    for (const methodName of customerAssetSetServiceStubMethods) {
      const callPromise = this.customerAssetSetServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v15.services.MutateCustomerAssetSetsResponse|MutateCustomerAssetSetsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v15/customer_asset_set_service.mutate_customer_asset_sets.js</caption>
 * region_tag:googleads_v15_generated_CustomerAssetSetService_MutateCustomerAssetSets_async
 */
  mutateCustomerAssetSets(
      request?: protos.google.ads.googleads.v15.services.IMutateCustomerAssetSetsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v15.services.IMutateCustomerAssetSetsResponse,
        protos.google.ads.googleads.v15.services.IMutateCustomerAssetSetsRequest|undefined, {}|undefined
      ]>;
  mutateCustomerAssetSets(
      request: protos.google.ads.googleads.v15.services.IMutateCustomerAssetSetsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v15.services.IMutateCustomerAssetSetsResponse,
          protos.google.ads.googleads.v15.services.IMutateCustomerAssetSetsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateCustomerAssetSets(
      request: protos.google.ads.googleads.v15.services.IMutateCustomerAssetSetsRequest,
      callback: Callback<
