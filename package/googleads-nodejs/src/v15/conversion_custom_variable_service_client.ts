 ...
 * `src/v15/conversion_custom_variable_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './conversion_custom_variable_service_client_config.json';
 ...
 * @memberof v15
 */
export class ConversionCustomVariableServiceClient {
  ...
  conversionCustomVariableServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof ConversionCustomVariableServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v15.services.ConversionCustomVariableService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.conversionCustomVariableServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v15.services.ConversionCustomVariableService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v15.services.ConversionCustomVariableService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const conversionCustomVariableServiceStubMethods =
        ['mutateConversionCustomVariables'];
    for (const methodName of conversionCustomVariableServiceStubMethods) {
      const callPromise = this.conversionCustomVariableServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v15.services.MutateConversionCustomVariablesResponse|MutateConversionCustomVariablesResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v15/conversion_custom_variable_service.mutate_conversion_custom_variables.js</caption>
 * region_tag:googleads_v15_generated_ConversionCustomVariableService_MutateConversionCustomVariables_async
 */
  mutateConversionCustomVariables(
      request?: protos.google.ads.googleads.v15.services.IMutateConversionCustomVariablesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v15.services.IMutateConversionCustomVariablesResponse,
        protos.google.ads.googleads.v15.services.IMutateConversionCustomVariablesRequest|undefined, {}|undefined
      ]>;
  mutateConversionCustomVariables(
      request: protos.google.ads.googleads.v15.services.IMutateConversionCustomVariablesRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v15.services.IMutateConversionCustomVariablesResponse,
          protos.google.ads.googleads.v15.services.IMutateConversionCustomVariablesRequest|null|undefined,
          {}|null|undefined>): void;
  mutateConversionCustomVariables(
      request: protos.google.ads.googleads.v15.services.IMutateConversionCustomVariablesRequest,
      callback: Callback<
