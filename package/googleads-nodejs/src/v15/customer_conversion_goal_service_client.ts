 ...
 * `src/v15/customer_conversion_goal_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './customer_conversion_goal_service_client_config.json';
 ...
 * @memberof v15
 */
export class CustomerConversionGoalServiceClient {
  ...
  customerConversionGoalServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof CustomerConversionGoalServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v15.services.CustomerConversionGoalService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.customerConversionGoalServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v15.services.CustomerConversionGoalService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v15.services.CustomerConversionGoalService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const customerConversionGoalServiceStubMethods =
        ['mutateCustomerConversionGoals'];
    for (const methodName of customerConversionGoalServiceStubMethods) {
      const callPromise = this.customerConversionGoalServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v15.services.MutateCustomerConversionGoalsResponse|MutateCustomerConversionGoalsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v15/customer_conversion_goal_service.mutate_customer_conversion_goals.js</caption>
 * region_tag:googleads_v15_generated_CustomerConversionGoalService_MutateCustomerConversionGoals_async
 */
  mutateCustomerConversionGoals(
      request?: protos.google.ads.googleads.v15.services.IMutateCustomerConversionGoalsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v15.services.IMutateCustomerConversionGoalsResponse,
        protos.google.ads.googleads.v15.services.IMutateCustomerConversionGoalsRequest|undefined, {}|undefined
      ]>;
  mutateCustomerConversionGoals(
      request: protos.google.ads.googleads.v15.services.IMutateCustomerConversionGoalsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v15.services.IMutateCustomerConversionGoalsResponse,
          protos.google.ads.googleads.v15.services.IMutateCustomerConversionGoalsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateCustomerConversionGoals(
      request: protos.google.ads.googleads.v15.services.IMutateCustomerConversionGoalsRequest,
      callback: Callback<
