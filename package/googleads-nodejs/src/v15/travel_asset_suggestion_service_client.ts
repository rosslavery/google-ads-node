 ...
 * `src/v15/travel_asset_suggestion_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './travel_asset_suggestion_service_client_config.json';
 ...
 * @memberof v15
 */
export class TravelAssetSuggestionServiceClient {
  ...
  travelAssetSuggestionServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof TravelAssetSuggestionServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v15.services.TravelAssetSuggestionService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.travelAssetSuggestionServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v15.services.TravelAssetSuggestionService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v15.services.TravelAssetSuggestionService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const travelAssetSuggestionServiceStubMethods =
        ['suggestTravelAssets'];
    for (const methodName of travelAssetSuggestionServiceStubMethods) {
      const callPromise = this.travelAssetSuggestionServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v15.services.SuggestTravelAssetsResponse|SuggestTravelAssetsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v15/travel_asset_suggestion_service.suggest_travel_assets.js</caption>
 * region_tag:googleads_v15_generated_TravelAssetSuggestionService_SuggestTravelAssets_async
 */
  suggestTravelAssets(
      request?: protos.google.ads.googleads.v15.services.ISuggestTravelAssetsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v15.services.ISuggestTravelAssetsResponse,
        protos.google.ads.googleads.v15.services.ISuggestTravelAssetsRequest|undefined, {}|undefined
      ]>;
  suggestTravelAssets(
      request: protos.google.ads.googleads.v15.services.ISuggestTravelAssetsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v15.services.ISuggestTravelAssetsResponse,
          protos.google.ads.googleads.v15.services.ISuggestTravelAssetsRequest|null|undefined,
          {}|null|undefined>): void;
  suggestTravelAssets(
      request: protos.google.ads.googleads.v15.services.ISuggestTravelAssetsRequest,
      callback: Callback<
