 ...
 * `src/v15/customer_user_access_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './customer_user_access_service_client_config.json';
 ...
 * @memberof v15
 */
export class CustomerUserAccessServiceClient {
  ...
  customerUserAccessServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof CustomerUserAccessServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v15.services.CustomerUserAccessService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.customerUserAccessServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v15.services.CustomerUserAccessService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v15.services.CustomerUserAccessService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const customerUserAccessServiceStubMethods =
        ['mutateCustomerUserAccess'];
    for (const methodName of customerUserAccessServiceStubMethods) {
      const callPromise = this.customerUserAccessServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 * @param {google.ads.googleads.v15.services.CustomerUserAccessOperation} request.operation
 *   Required. The operation to perform on the customer
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v15.services.MutateCustomerUserAccessResponse|MutateCustomerUserAccessResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v15/customer_user_access_service.mutate_customer_user_access.js</caption>
 * region_tag:googleads_v15_generated_CustomerUserAccessService_MutateCustomerUserAccess_async
 */
  mutateCustomerUserAccess(
      request?: protos.google.ads.googleads.v15.services.IMutateCustomerUserAccessRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v15.services.IMutateCustomerUserAccessResponse,
        protos.google.ads.googleads.v15.services.IMutateCustomerUserAccessRequest|undefined, {}|undefined
      ]>;
  mutateCustomerUserAccess(
      request: protos.google.ads.googleads.v15.services.IMutateCustomerUserAccessRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v15.services.IMutateCustomerUserAccessResponse,
          protos.google.ads.googleads.v15.services.IMutateCustomerUserAccessRequest|null|undefined,
          {}|null|undefined>): void;
  mutateCustomerUserAccess(
      request: protos.google.ads.googleads.v15.services.IMutateCustomerUserAccessRequest,
      callback: Callback<
