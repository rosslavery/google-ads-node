 ...
 * `src/v15/customer_sk_ad_network_conversion_value_schema_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './customer_sk_ad_network_conversion_value_schema_service_client_config.json';
 ...
 * @memberof v15
 */
export class CustomerSkAdNetworkConversionValueSchemaServiceClient {
  ...
  customerSkAdNetworkConversionValueSchemaServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof CustomerSkAdNetworkConversionValueSchemaServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v15.services.CustomerSkAdNetworkConversionValueSchemaService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.customerSkAdNetworkConversionValueSchemaServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v15.services.CustomerSkAdNetworkConversionValueSchemaService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v15.services.CustomerSkAdNetworkConversionValueSchemaService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const customerSkAdNetworkConversionValueSchemaServiceStubMethods =
    ...
    for (const methodName of customerSkAdNetworkConversionValueSchemaServiceStubMethods) {
      const callPromise = this.customerSkAdNetworkConversionValueSchemaServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 * @param {google.ads.googleads.v15.services.CustomerSkAdNetworkConversionValueSchemaOperation} request.operation
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v15.services.MutateCustomerSkAdNetworkConversionValueSchemaResponse|MutateCustomerSkAdNetworkConversionValueSchemaResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v15/customer_sk_ad_network_conversion_value_schema_service.mutate_customer_sk_ad_network_conversion_value_schema.js</caption>
 * region_tag:googleads_v15_generated_CustomerSkAdNetworkConversionValueSchemaService_MutateCustomerSkAdNetworkConversionValueSchema_async
 */
  mutateCustomerSkAdNetworkConversionValueSchema(
      request?: protos.google.ads.googleads.v15.services.IMutateCustomerSkAdNetworkConversionValueSchemaRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v15.services.IMutateCustomerSkAdNetworkConversionValueSchemaResponse,
        protos.google.ads.googleads.v15.services.IMutateCustomerSkAdNetworkConversionValueSchemaRequest|undefined, {}|undefined
      ]>;
  mutateCustomerSkAdNetworkConversionValueSchema(
      request: protos.google.ads.googleads.v15.services.IMutateCustomerSkAdNetworkConversionValueSchemaRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v15.services.IMutateCustomerSkAdNetworkConversionValueSchemaResponse,
          protos.google.ads.googleads.v15.services.IMutateCustomerSkAdNetworkConversionValueSchemaRequest|null|undefined,
          {}|null|undefined>): void;
  mutateCustomerSkAdNetworkConversionValueSchema(
      request: protos.google.ads.googleads.v15.services.IMutateCustomerSkAdNetworkConversionValueSchemaRequest,
      callback: Callback<
