 ...
 * `src/v15/ad_group_customizer_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './ad_group_customizer_service_client_config.json';
 ...
 * @memberof v15
 */
export class AdGroupCustomizerServiceClient {
  ...
  adGroupCustomizerServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof AdGroupCustomizerServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v15.services.AdGroupCustomizerService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.adGroupCustomizerServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v15.services.AdGroupCustomizerService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v15.services.AdGroupCustomizerService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const adGroupCustomizerServiceStubMethods =
        ['mutateAdGroupCustomizers'];
    for (const methodName of adGroupCustomizerServiceStubMethods) {
      const callPromise = this.adGroupCustomizerServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v15.services.MutateAdGroupCustomizersResponse|MutateAdGroupCustomizersResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v15/ad_group_customizer_service.mutate_ad_group_customizers.js</caption>
 * region_tag:googleads_v15_generated_AdGroupCustomizerService_MutateAdGroupCustomizers_async
 */
  mutateAdGroupCustomizers(
      request?: protos.google.ads.googleads.v15.services.IMutateAdGroupCustomizersRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v15.services.IMutateAdGroupCustomizersResponse,
        protos.google.ads.googleads.v15.services.IMutateAdGroupCustomizersRequest|undefined, {}|undefined
      ]>;
  mutateAdGroupCustomizers(
      request: protos.google.ads.googleads.v15.services.IMutateAdGroupCustomizersRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v15.services.IMutateAdGroupCustomizersResponse,
          protos.google.ads.googleads.v15.services.IMutateAdGroupCustomizersRequest|null|undefined,
          {}|null|undefined>): void;
  mutateAdGroupCustomizers(
      request: protos.google.ads.googleads.v15.services.IMutateAdGroupCustomizersRequest,
      callback: Callback<
