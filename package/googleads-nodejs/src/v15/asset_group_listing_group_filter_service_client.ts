 ...
 * `src/v15/asset_group_listing_group_filter_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './asset_group_listing_group_filter_service_client_config.json';
 ...
 * @memberof v15
 */
export class AssetGroupListingGroupFilterServiceClient {
  ...
  assetGroupListingGroupFilterServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof AssetGroupListingGroupFilterServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v15.services.AssetGroupListingGroupFilterService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.assetGroupListingGroupFilterServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v15.services.AssetGroupListingGroupFilterService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v15.services.AssetGroupListingGroupFilterService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const assetGroupListingGroupFilterServiceStubMethods =
        ['mutateAssetGroupListingGroupFilters'];
    for (const methodName of assetGroupListingGroupFilterServiceStubMethods) {
      const callPromise = this.assetGroupListingGroupFilterServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v15.services.MutateAssetGroupListingGroupFiltersResponse|MutateAssetGroupListingGroupFiltersResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v15/asset_group_listing_group_filter_service.mutate_asset_group_listing_group_filters.js</caption>
 * region_tag:googleads_v15_generated_AssetGroupListingGroupFilterService_MutateAssetGroupListingGroupFilters_async
 */
  mutateAssetGroupListingGroupFilters(
      request?: protos.google.ads.googleads.v15.services.IMutateAssetGroupListingGroupFiltersRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v15.services.IMutateAssetGroupListingGroupFiltersResponse,
        protos.google.ads.googleads.v15.services.IMutateAssetGroupListingGroupFiltersRequest|undefined, {}|undefined
      ]>;
  mutateAssetGroupListingGroupFilters(
      request: protos.google.ads.googleads.v15.services.IMutateAssetGroupListingGroupFiltersRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v15.services.IMutateAssetGroupListingGroupFiltersResponse,
          protos.google.ads.googleads.v15.services.IMutateAssetGroupListingGroupFiltersRequest|null|undefined,
          {}|null|undefined>): void;
  mutateAssetGroupListingGroupFilters(
      request: protos.google.ads.googleads.v15.services.IMutateAssetGroupListingGroupFiltersRequest,
      callback: Callback<
