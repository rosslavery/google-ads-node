 ...
 * `src/v15/campaign_group_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './campaign_group_service_client_config.json';
 ...
 * @memberof v15
 */
export class CampaignGroupServiceClient {
  ...
  campaignGroupServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof CampaignGroupServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v15.services.CampaignGroupService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.campaignGroupServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v15.services.CampaignGroupService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v15.services.CampaignGroupService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const campaignGroupServiceStubMethods =
        ['mutateCampaignGroups'];
    for (const methodName of campaignGroupServiceStubMethods) {
      const callPromise = this.campaignGroupServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.ads.googleads.v15.services.MutateCampaignGroupsResponse|MutateCampaignGroupsResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v15/campaign_group_service.mutate_campaign_groups.js</caption>
 * region_tag:googleads_v15_generated_CampaignGroupService_MutateCampaignGroups_async
 */
  mutateCampaignGroups(
      request?: protos.google.ads.googleads.v15.services.IMutateCampaignGroupsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v15.services.IMutateCampaignGroupsResponse,
        protos.google.ads.googleads.v15.services.IMutateCampaignGroupsRequest|undefined, {}|undefined
      ]>;
  mutateCampaignGroups(
      request: protos.google.ads.googleads.v15.services.IMutateCampaignGroupsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v15.services.IMutateCampaignGroupsResponse,
          protos.google.ads.googleads.v15.services.IMutateCampaignGroupsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateCampaignGroups(
      request: protos.google.ads.googleads.v15.services.IMutateCampaignGroupsRequest,
      callback: Callback<
