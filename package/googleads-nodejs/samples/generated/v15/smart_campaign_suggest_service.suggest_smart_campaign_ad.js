...
function main(customerId, suggestionInfo) {
  // [START googleads_v15_generated_SmartCampaignSuggestService_SuggestSmartCampaignAd_async]
  /**
  ...
  async function callSuggestSmartCampaignAd() {
    ...
    // Run request
    const response = await googleadsClient.suggestSmartCampaignAd(request);
    console.log(response);
  }

  callSuggestSmartCampaignAd();
  // [END googleads_v15_generated_SmartCampaignSuggestService_SuggestSmartCampaignAd_async]
}
