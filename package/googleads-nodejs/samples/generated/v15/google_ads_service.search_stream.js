...
function main(customerId, query) {
  // [START googleads_v15_generated_GoogleAdsService_SearchStream_async]
  /**
  ...
  const {GoogleAdsServiceClient} = require('google-ads').v15;
  ...
  async function callSearchStream() {
    ...
    // Run request
    const stream = await googleadsClient.searchStream(request);
  ...
  callSearchStream();
  // [END googleads_v15_generated_GoogleAdsService_SearchStream_async]
}
