...
function main(customerId, operations) {
  // [START googleads_v15_generated_RecommendationService_ApplyRecommendation_async]
  /**
  ...
  async function callApplyRecommendation() {
    ...
    // Run request
    const response = await googleadsClient.applyRecommendation(request);
    console.log(response);
  }

  callApplyRecommendation();
  // [END googleads_v15_generated_RecommendationService_ApplyRecommendation_async]
}
