...
function main(customerId, operations) {
  // [START googleads_v15_generated_CampaignService_MutateCampaigns_async]
  /**
  ...
  const {CampaignServiceClient} = require('google-ads').v15;

  // Instantiates a client
  const googleadsClient = new CampaignServiceClient();

  async function callMutateCampaigns() {
    // Construct request
    const request = {
      customerId,
      operations,
    ...
    // Run request
    const response = await googleadsClient.mutateCampaigns(request);
    console.log(response);
  }

  callMutateCampaigns();
  // [END googleads_v15_generated_CampaignService_MutateCampaigns_async]
}
