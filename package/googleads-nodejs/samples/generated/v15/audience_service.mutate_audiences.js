...
function main(customerId, operations) {
  // [START googleads_v15_generated_AudienceService_MutateAudiences_async]
  /**
  ...
  const {AudienceServiceClient} = require('google-ads').v15;

  // Instantiates a client
  const googleadsClient = new AudienceServiceClient();

  async function callMutateAudiences() {
    // Construct request
    const request = {
      customerId,
      operations,
    ...
    // Run request
    const response = await googleadsClient.mutateAudiences(request);
    console.log(response);
  }

  callMutateAudiences();
  // [END googleads_v15_generated_AudienceService_MutateAudiences_async]
}
