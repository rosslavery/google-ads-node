...
function main(customerId, campaign, suggestionInfo) {
  // [START googleads_v15_generated_SmartCampaignSuggestService_SuggestSmartCampaignBudgetOptions_async]
  /**
  ...
  const {SmartCampaignSuggestServiceClient} = require('google-ads').v15;
  ...
  async function callSuggestSmartCampaignBudgetOptions() {
    ...
    // Run request
    const response = await googleadsClient.suggestSmartCampaignBudgetOptions(request);
    console.log(response);
  }

  callSuggestSmartCampaignBudgetOptions();
  // [END googleads_v15_generated_SmartCampaignSuggestService_SuggestSmartCampaignBudgetOptions_async]
}
