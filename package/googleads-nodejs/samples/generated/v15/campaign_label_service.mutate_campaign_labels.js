...
function main(customerId, operations) {
  // [START googleads_v15_generated_CampaignLabelService_MutateCampaignLabels_async]
  /**
  ...
  const {CampaignLabelServiceClient} = require('google-ads').v15;
  ...
  async function callMutateCampaignLabels() {
    ...
    // Run request
    const response = await googleadsClient.mutateCampaignLabels(request);
    console.log(response);
  }

  callMutateCampaignLabels();
  // [END googleads_v15_generated_CampaignLabelService_MutateCampaignLabels_async]
}
