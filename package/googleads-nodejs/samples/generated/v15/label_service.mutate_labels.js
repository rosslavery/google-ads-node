...
function main(customerId, operations) {
  // [START googleads_v15_generated_LabelService_MutateLabels_async]
  /**
  ...
  const {LabelServiceClient} = require('google-ads').v15;

  // Instantiates a client
  const googleadsClient = new LabelServiceClient();

  async function callMutateLabels() {
    // Construct request
    const request = {
      customerId,
      operations,
  ...
  callMutateLabels();
  // [END googleads_v15_generated_LabelService_MutateLabels_async]
}
