...
function main(customerId, operations) {
  // [START googleads_v15_generated_AssetGroupAssetService_MutateAssetGroupAssets_async]
  /**
  ...
  const {AssetGroupAssetServiceClient} = require('google-ads').v15;
  ...
  async function callMutateAssetGroupAssets() {
    ...
    // Run request
    const response = await googleadsClient.mutateAssetGroupAssets(request);
    console.log(response);
  }

  callMutateAssetGroupAssets();
  // [END googleads_v15_generated_AssetGroupAssetService_MutateAssetGroupAssets_async]
}
