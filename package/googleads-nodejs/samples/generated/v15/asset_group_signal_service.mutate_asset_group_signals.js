...
function main(customerId, operations) {
  // [START googleads_v15_generated_AssetGroupSignalService_MutateAssetGroupSignals_async]
  /**
  ...
  const {AssetGroupSignalServiceClient} = require('google-ads').v15;

  // Instantiates a client
  const googleadsClient = new AssetGroupSignalServiceClient();

  async function callMutateAssetGroupSignals() {
    // Construct request
    const request = {
      customerId,
      operations,
    ...
    // Run request
    const response = await googleadsClient.mutateAssetGroupSignals(request);
    console.log(response);
  }

  callMutateAssetGroupSignals();
  // [END googleads_v15_generated_AssetGroupSignalService_MutateAssetGroupSignals_async]
}
