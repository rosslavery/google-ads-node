...
function main(customerId, operations) {
  // [START googleads_v15_generated_CampaignBudgetService_MutateCampaignBudgets_async]
  /**
  ...
  const {CampaignBudgetServiceClient} = require('google-ads').v15;
  ...
  async function callMutateCampaignBudgets() {
    ...
    // Run request
    const response = await googleadsClient.mutateCampaignBudgets(request);
    console.log(response);
  }

  callMutateCampaignBudgets();
  // [END googleads_v15_generated_CampaignBudgetService_MutateCampaignBudgets_async]
}
