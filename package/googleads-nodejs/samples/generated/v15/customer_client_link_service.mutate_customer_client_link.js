...
function main(customerId, operation) {
  // [START googleads_v15_generated_CustomerClientLinkService_MutateCustomerClientLink_async]
  /**
  ...
  const {CustomerClientLinkServiceClient} = require('google-ads').v15;
  ...
  async function callMutateCustomerClientLink() {
    ...
    // Run request
    const response = await googleadsClient.mutateCustomerClientLink(request);
    console.log(response);
  }

  callMutateCustomerClientLink();
  // [END googleads_v15_generated_CustomerClientLinkService_MutateCustomerClientLink_async]
}
