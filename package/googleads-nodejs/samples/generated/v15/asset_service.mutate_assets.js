...
function main(customerId, operations) {
  // [START googleads_v15_generated_AssetService_MutateAssets_async]
  /**
  ...
  const {AssetServiceClient} = require('google-ads').v15;

  // Instantiates a client
  const googleadsClient = new AssetServiceClient();

  async function callMutateAssets() {
    // Construct request
    const request = {
      customerId,
      operations,
  ...
  callMutateAssets();
  // [END googleads_v15_generated_AssetService_MutateAssets_async]
}
