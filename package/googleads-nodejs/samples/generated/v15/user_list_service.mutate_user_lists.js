...
function main(customerId, operations) {
  // [START googleads_v15_generated_UserListService_MutateUserLists_async]
  /**
  ...
  const {UserListServiceClient} = require('google-ads').v15;
  ...
  async function callMutateUserLists() {
    ...
    // Run request
    const response = await googleadsClient.mutateUserLists(request);
    console.log(response);
  }

  callMutateUserLists();
  // [END googleads_v15_generated_UserListService_MutateUserLists_async]
}
